!(function (e, t) {
    ...
    (() => {
        ...
        function c() {
            try {
                return new Promise(function (e, t) {
                    try {
                        navigator && navigator.getBattery
                            ? navigator
                                  .getBattery()
                                  .then(function (t) {
                                      var r = (
        ...
        function d(e, t, r) {
            const n = new Date();
            n.setTime(n.getTime() + 365 * r * 24 * 60 * 60 * 1e3);
        ...
        function m() {
            try {
                if (localStorage && null !== localStorage.getItem("deviceHash"))
                    d("cf_deviceHash", localStorage.getItem("deviceHash"), 30),
                        localStorage.removeItem("deviceHash");
                else if ("" == l("cf_deviceHash")) {
                    const e = 64,
                        t = new Uint8Array(e);
                    crypto.getRandomValues(t);
                    let r = "";
                    for (let n = 0; n < e; n++) r += t[n] % 10;
                    d("cf_deviceHash", r, 30);
                }
                return l("cf_deviceHash");
            } catch (e) {
                return "NA";
            }
        }
        ...
        async function k() {
            let e = {
                ...
                screen_height: A(),
                region_timezone: x(),
                region_timezone_offset: h(),
                region_language: S(),
                installed_fonts: a(),
                installed_plugins: i(),
                gpu_renderer: s(),
            };
            const [t, d, l, k] = await Promise.all([u(), g(), f(), c()]);
            return (
                (e = {
                    ...e,
                    session_id: t,
        ...
        e.r(t), e.d(t, { default: () => N, getBrowserData: () => k });
        const N = { getBrowserData: k };
        return t;
    })()
);
